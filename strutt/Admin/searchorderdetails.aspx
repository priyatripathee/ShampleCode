                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <%# Eval("custom_bag_param")%><br /><%# Eval("custom_bag_price")%><br />
                                                     <a href='../preview_cust_img.aspx?proid=<%# Eval("product_id")%>&orddetid=<%# Eval("order_detail_id")%>' target="_blank"  
                                                         class='<%# String.IsNullOrEmpty(Eval("custom_bag_param").ToString())? "hidden":"btn btn-info btn-xs" %>' >
