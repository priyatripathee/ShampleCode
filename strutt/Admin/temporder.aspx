<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_main.Master" AutoEventWireup="true" CodeBehind="temporder.aspx.cs" Inherits="strutt.Admin.temporder" %>
    ...
    <section class="page--header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6"> 
            <!-- Page Title Start -->
            <h2 class="page--title h5">Partial Order</h2>
            <!-- Page Title End -->
            
            <ul class="breadcrumb">
              <li class="breadcrumb-item">Order Status</li>
              <li class="breadcrumb-item active"><a href="temporder.aspx"><span>Partial Order</span></a></li>
          </div>
            </ul>
          <div class="col-lg-6"> 
                ...
                <div class="panel">
                    ...
                    <div class="records--header">
                        <div class="title fa-shopping-bag">
                            <h3 class="h3">Partial Order<a href="#" class="btn btn-sm btn-outline-info">Temporory Order</a></h3>
                         ...
                         <div class="col-md-2">
                             <label>To Date <span class="required"></span>
                        </label>
           ...
           <div class="panel">
                <div class="x_content">
                    <div class="table-responsive">
                        ...
                        <asp:GridView ID="grdTempOrder" runat="server" Width="100%"  CssClass="table table-striped jambo_table bulk_action"
                             OnRowCommand="grdPartialOrder_RowCommand" AutoGenerateColumns="False" DataKeyNames="order_id,name">
                             ...
                             <asp:TemplateField HeaderText="Sr." ItemStyle-HorizontalAlign="Center">
                                ...
                                <asp:TemplateField HeaderText="Name">
                                   ...
                                   <asp:TemplateField HeaderText="Address">
                                    ...
                                    <asp:TemplateField HeaderText="Landmark, Pincode">
                                    <ItemTemplate>
                                        <%# Eval("land_mark")%></br>
                                         <%# Eval("pin_code")%>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Email Id,Phone number">
                                    <ItemTemplate>
                                        <%# Eval("email_id")%></br>
                                        <%# Eval("contact_number")%>
                                    </ItemTemplate>
                                    ...
                                    <ItemTemplate>
                                        <%--<asp:Label ID="lblstatus" Visible="false" runat="server" Text='<%# Eval("is_active") %>'
                                           ...
                                           <asp:ImageButton ID="imgBtnActive" runat="server" AlternateText='<%# Eval("is_active").ToString().ToLower()=="true" ? "Active" : "Inactive" %>'
                                            ...
                                            <asp:LinkButton ID="btnEmail" runat="server"   CommandName="SendEmail" 
                                            CommandArgument='<%# Bind("order_id") %>' ToolTip="Email" CssClass="label label-info" >Email</asp:LinkButton>                                                           
                                    </ItemTemplate>
