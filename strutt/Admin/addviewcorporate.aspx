<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_main.Master" AutoEventWireup="true" CodeBehind="addviewcorporate.aspx.cs" Inherits="strutt.Admin.addviewcorporate" %>
    ...
    <asp:UpdatePanel ID="UPnlBlog" runat="server">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6"> 
            <!-- Page Title Start -->
            <h2 class="page--title h5">Corporate</h2>
            <!-- Page Title End -->
            <ul class="breadcrumb">
              <li class="breadcrumb-item">Corporate</li>
              <li class="breadcrumb-item active"><a href="manageblog.aspx"><span>Manage Corporate </span></a></li>
            </ul>
          </div>
          <div class="col-lg-6"> 
      ...
      <div class="panel nav-tabs"> 
        ...
        <div class="records--header">
          <div class="title fa-shopping-bag">
            <h3 class="h3">Corporate <%--<a href="#" class="btn btn-sm btn-outline-info">Manage Lookbook</a>--%></h3>
        ...
        <div class="records--body"> 
          <div class="tab-content"> 
            <div>
                 ...
                 <div class="form-group row"> <span class="label-text col-md-2 col-form-label">Image (Corporate): <span class="requied"> * </span></span>
                    <div class="col-md-4">
                            ...
                            <div class="table-responsive">
                                <div id="frm" method="post">
                                    ...
                                    <asp:GridView ID="gvLookbook" runat="server" Width="100%" CssClass="table table-striped jambo_table bulk_action"
                                        AutoGenerateColumns="False" DataKeyNames="corporateId" OnRowCommand="gvLookbook_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Image" ItemStyle-VerticalAlign="Top">
                                                <ItemTemplate>
                                                    <asp:Image ID="imgLarge" runat="server" Width="100px" Height="60px" ImageUrl='<%# "~/images/corp_img/" + Eval("image") %>' />
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Active" ItemStyle-HorizontalAlign="Center" >
                                                <ItemTemplate>
                                                    ...
                                                    <asp:ImageButton ID="imgBtnActive" runat="server" AlternateText='<%# Eval("is_active").ToString().ToLower()=="true" ? "Active" : "Inactive" %>'
                                                        ...
                                                        CommandName="Active" CommandArgument='<%# Eval("corporateId") %>' />
                                                </ItemTemplate>
                                                <ItemStyle Width="50px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnImgEdit" runat="server" CommandName="EditRecored"
                                                        CommandArgument='<%# Bind("corporateId") %>' ToolTip="Edit" CssClass="label label-success" style="margin-bottom: 5px;"><i class="fa fa-edit"></i> edit</asp:LinkButton>
                                                    <asp:LinkButton ID="btnImgDelete" runat="server" CommandName="Delete"
                                                        CommandArgument='<%# Bind("corporateId") %>' ToolTip="Delete" CssClass="label label-danger" OnClientClick="javascript:return confirm('Are you sure you want to Remove this Banner!');"><i class="fa fa-trash"></i> delete</asp:LinkButton>
                                                </ItemTemplate>
