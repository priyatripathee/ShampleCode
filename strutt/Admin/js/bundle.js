...
! function (t, e) {
	...
	var Re = ["swal-title", "swal-html", "swal-footer"],
		...
		un = function (e, t, n) {
			t.showLoaderOnDeny && $t(q()), t.preDeny ? Promise.resolve().then(function () {
	...
	function Bn(a, c, s) {
		return new Promise(function (t) {
			...
			ke.swalPromiseResolve.set(a, t), c.confirmButton.onclick = function () {
				...
				capture: t.keydownListenerCapture
			}), t.keydownHandlerAdded = !0), (s.toast && (s.input || s.footer || s.showCloseButton) ? vt : bt)(document.body, $["toast-column"]), r = a, "select" === (t = s).input || "radio" === t.input ? en(r, t) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(t.input) && (b(t.inputValue) || w(t.inputValue)) && nn(r, t), Ie(s), En(ee, s, e), On(c, s), setTimeout(function () {
	...
	}), In.DismissReason = Q, In.version = "10.14.0";
	var Mn = In;
