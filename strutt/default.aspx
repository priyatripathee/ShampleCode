<%@ Page Title="Built for Carefree & Convenient Travel" MetaDescription="Strutt is here with the Trendiest Travel bag collection there is. Choose from a range of Duffle bags, Cabin Bags, Weekenders, Packing cubes, travel essential to make your trip fun, exciting and convenient. A never seen before- variety of Lightweight, Spacious Travel bagsin multiple color options for both Men &Women." Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="strutt._default" %>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="logo text-md-left">
                            <a href="../default.aspx"><img src="assets/images/logo/logo.jpg" alt=""></a>
                        </div>
                    </div>
                    ...
                    <div class="row row--5">
                            ...
                            <div class="hero-product-image mt-10">
                                ...
                                <div class="product-banner-title">
                                    <h4 class="hover-style-link">
                                        <b class="color-w"><asp:Label ID="lblBName1" runat="server" Visible="false"></asp:Label></b></h4>
                                    <h6 class="hidden">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="hero-product-image mt-10">
                                ...
                                <div class="product-banner-title">
                                    <h4>
                                        <asp:Label ID="lblBName2" runat="server" Visible="false"></asp:Label></h4>
                                    <h6 class="hidden">
                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="hero-product-image mt-10">
                                ...
                                <div class="product-banner-title">
                                    <h4>
                                        <asp:Label ID="lblBName3" runat="server" Visible="false"></asp:Label></h4>
                                    <h6 class="hidden">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="hero-product-image mt-10">
                                ...
                                <div class="product-banner-title">
                                    <h4>
                                        <asp:Label ID="lblBName4" runat="server" Visible="false"></asp:Label></h4>
                                    <h6 class="hidden">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="hero-product-image mt-10">
                                ...
                                <div class="product-banner-title">
                                    <h4>
                                        <asp:Label ID="lblBName5" runat="server" Visible="false"></asp:Label></h4>
                                    <h6 class="hidden">
                        ...
                        <div class="col-lg-8">
                            <ul class="nav product-tab-menu justify-content-lg-end justify-content-center" role="tablist">
                                ...
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_02" role="tab">Travel Bags</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_03" role="tab">Travel Accessories</a>
                                </li>
                                <li class="tab__item nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab_list_04" role="tab">Travel Essentials</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div>
                                        <div class="product-cats section-space--mb_60 text-center">
                                            <label>
                                                ...
                                                <span class="line-hover"><a href="/">Home</a></span>
                                            </label>
                                            <label>
                                        ...
                                        <%--<asp:Repeater ID="rptMenu1" runat="server">
                                            ...
                                            <label>
                                                ...
                                                <span class="line-hover"><a href="/backpacks">Backpacks
                                            ...
                                            <label>
                                                ...
                                                <span class="line-hover"><a href="/business-travel">Business Travel
                                        <asp:Repeater ID="rptMenu5" runat="server">
                                            ...
                                            <label>
                                                ...
                                                <span class="line-hover"><a href="/leisure-travel">Leisure Travel<asp:Repeater ID="rptMenu6" runat="server">
                                                    <ItemTemplate>
                                                        <div class="sub-category">
                                                            <a href='<%# "../../../"+Eval("menu_url")+"/"+Eval("sub_menu_url") %>' class='<%# Convert.ToBoolean(Eval("is_new"))? "link new ":"link " %>'><%#Eval("sub_menu_name")%></a>
                                                        </div>
                                            ...
                                            <label>
                                                <input type="radio" name="product_cat" value="chair">
                                                <span class="line-hover"><a href="/one-day-travel">One Day Travel<asp:Repeater ID="rptMenu3" runat="server">
                                                    <ItemTemplate>
                                                        <div class="sub-category">
                                                            <a href='<%# "../../../"+Eval("menu_url")+"/"+Eval("sub_menu_url") %>' class='<%# Convert.ToBoolean(Eval("is_new"))? "link new ":"link " %>'><%#Eval("sub_menu_name")%></a>
                                                        </div>
                                            ...
                                            <label>
                                                <input type="radio" name="product_cat" value="chair">
                                                <span class="line-hover"><a href="/travel-accessories">Travel Accessories<asp:Repeater ID="rptMenu4" runat="server">
                                                    <ItemTemplate>
                                                        <div class="sub-category">
                                                            <a href='<%# "../../../"+Eval("menu_url")+"/"+Eval("sub_menu_url") %>' class='<%# Convert.ToBoolean(Eval("is_new"))? "link new ":"link " %>'><%#Eval("sub_menu_name")%></a>
                                                        </div>
                ...
                <div class="mobile-menu-overlay__body">
                    <nav class="offcanvas-navigation">
                        <ul>
                            ...
                            <li class="has-children"><a href="../../category.aspx"> Category</a>
                                <ul class="sub-menu">
                                    <li><a href="/travel-bags">TRAVEL BAGS
                                    ...
                                    <li><a href="/one-day-travel">One Day Travel
                                    ...
                                    <li><a href="/travel-accessories">Travel Accessories<asp:Repeater ID="rptMenuM4" runat="server">
                                        <ItemTemplate>
                                            <div class="sub-category">
                                                <a href='<%# "../../../"+Eval("menu_url")+"/"+Eval("sub_menu_url") %>' class='<%# Convert.ToBoolean(Eval("is_new"))? "link new ":"link " %>'><%#Eval("sub_menu_name")%></a>
                                            </div>
                                    ...
                                    <li><a href="/business-travel">Business Travel<asp:Repeater ID="rptMenuM5" runat="server">
                                        <ItemTemplate>
                                            <div class="sub-category">
                                                <a href='<%# "../../../"+Eval("menu_url")+"/"+Eval("sub_menu_url") %>' class='<%# Convert.ToBoolean(Eval("is_new"))? "link new ":"link " %>'><%#Eval("sub_menu_name")%></a>
                                            </div>
                                    ...
                                    <li><a href="/leisure-travel">Leisure Travel<asp:Repeater ID="rptMenuM6" runat="server">
                                        <ItemTemplate>
                                            <div class="sub-category">
                                                <a href='<%# "../../../"+Eval("menu_url")+"/"+Eval("sub_menu_url") %>' class='<%# Convert.ToBoolean(Eval("is_new"))? "link new ":"link " %>'><%#Eval("sub_menu_name")%></a>
                                            </div>
                                    ...
                                    <li><a href="/travel-essentials">Travel Essentials<asp:Repeater ID="rptMenu7" runat="server">
                                        <ItemTemplate>
                                            <div class="sub-category">
                                                <a href='<%# "../../../"+Eval("menu_url")+"/"+Eval("sub_menu_url") %>' class='<%# Convert.ToBoolean(Eval("is_new"))? "link new ":"link " %>'><%#Eval("sub_menu_name")%></a>
                                            </div>
