...
namespace api
{
    public class PickerApiService
    {
        ...
        public int placeorder_api(int Orderid, string productname, string custname, string custemail, string custnumber, string custpincode, string custaddress)
        {
            ...
            if (checkpincode_api(PickerOrder.to_pincode))
            {
                ...
                {
                    if (ds.Tables[0].Rows[0]["payment_through"].Equals("COD"))
                        PickerOrder.cod_amount = PayableAmt;
                ...
                if (PickerOrder.success == true)
                {
                    ...
                    if (result)
                    {
                        ...
                        return 3;   // Fail to Save In Database
                }

                else
                    return 2;   // Fail to Save at Picker Side
            }

            else
                return 1;       // Pickup is Not Avaiable for This Pincode
        }
        #endregion
