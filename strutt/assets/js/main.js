(function ($) {
   ...
   // Magnific Popup Image
    ...
    shopFiltericon.on('click', function() {
        ...
        //$('.shop-category-active').toggleClass('active');
    })

    /*--
        Shop category active 
    ---------------------------------- */
    $('.shop-category-active , .category-close').on('click', function (e) {
        e.preventDefault();
        $('.product-category-wrapper').slideToggle();
    })

    var shopFiltericon = $('.shop-category-active , .category-close');
    shopFiltericon.on('click', function () {
        $('.shop-category-active').toggleClass('active');
    })
