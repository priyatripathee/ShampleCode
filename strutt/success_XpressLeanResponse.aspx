<%@ Page Title="" Language="C#" MasterPageFile="~/master/main.Master" AutoEventWireup="true"
    CodeBehind="success_XpressLeanResponse.aspx.cs" Inherits="strutt.success_XpressLeanResponse" %>
        ...
        <div class="margin-t-40">
            <div class="flex main-center">
                <div class="col-12-12 col-sm-4-12 text-center">
                    <p>
                        <img style="width: 200px;" src="img/order_success_v1.png" /></p>
                    <h1 id="lblSuccessHead" runat="server" style="color: Green;">Successful Transactions</h1>
                    <p>STR10001<asp:Label ID="lblOrderNo" runat="server"></asp:Label>
                        Your order has been placed Sucessfully!</p>
                    <br>
