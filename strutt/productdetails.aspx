...
<div id="jas-content">
    ...
    <div class="page-head pr tc" style="background: url(https://thestruttstore.com/images/shop-banner.jpg) no-repeat center center / cover;">
            <div class="jas-container pr">
                <h1 class="tu mb__10 cw" itemprop="headline">Product Details</h1>
                <p></p>
      ...
      <div class="row">
        <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12"> 
          ...
          <div class="product-details-left">
            ...
            <div class="product-details-thumbs-2 slider-thumbs-2" data-slick="{"slidesToShow": 1, "slidesToScroll": 1, "adaptiveHeight":true, "asNavFor": ".p-nav", "fade":true}">
                <button type="button" class="slick-prev"><i class="arrow up"></i></button>
              <asp:Repeater ID="rptimgZoom" runat="server">
                <ItemTemplate>
                  <div class="sm-image"> 
                      <img id="imgzoomsmall" runat="server" src='<%# "~/images/Product/Thumb/" + Eval("thumb_image") %>' alt="product image thumb" width="80" />
                  </div>
                </ItemTemplate>
              </asp:Repeater>
                <button type="button" class="slick-prev"><i class="arrow down"></i></button>
            </div>
            <!--// Product Details Left --> 
          </div>
        </div>
              ...
              <div class="quickview-cart-box">
                <div class="quickview-button">
                  ...
                  <div class="quickview-cart button">
                    ...
                    <br>
                  <div class="quickview-cart button" style="display:none;">
                      <asp:LinkButton ID="lbtnPersonatize" runat="server" CssClass="btn--lg btn--black font-weight--reguler text-white" OnClick="lbtnPersonatize_Click">Personalized Bags</asp:LinkButton>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="quickview-action-wrap mt-30">
            <ul class="offer_three">
              <li>
                <div class="sku_wrapper item_meta offer_three"> <span class="label"><a href="https://wa.me/+918800400570" target="_blank"> <img src="../../images/wp.png" alt="" /> </a></span><span class="sku">Can't decide, have more questions, Ask your Travel Expert now ... </span> </div>
              </li>
              <li>
