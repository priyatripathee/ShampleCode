<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_main.Master" AutoEventWireup="true"
    CodeBehind="manageblog.aspx.cs" Inherits="strutt.Admin.manageblog" %>
    ...
    <asp:UpdatePanel ID="UPnlBlog" runat="server">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6"> 
            <!-- Page Title Start -->
            <h2 class="page--title h5">Blog/Review</h2>
            <!-- Page Title End -->
            <ul class="breadcrumb">
              <li class="breadcrumb-item">Blog</li>
              <li class="breadcrumb-item active"><a href="manageblog.aspx"><span>Manage Blog </span></a></li>
            </ul>
          </div>
          <div class="col-lg-6"> 
      ...
      <div class="panel nav-tabs"> 
        ...
        <div class="records--header">
          <div class="title fa-shopping-bag">
            <h3 class="h3">Blog <a href="#" class="btn btn-sm btn-outline-info">Manage Blog</a></h3>
        ...
        <div class="records--body"> 
          <div class="tab-content"> 
            <div>
                ...
                <div class="form-group row"> <span class="label-text col-md-2 col-form-label">Title: <span class="requied"> * </span></span>
                  <div class="col-md-4">
                    <asp:TextBox ID="txtTitle" runat="server" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RFVTName" runat="server" ErrorMessage="Please enter title"
                            ControlToValidate="txtTitle" ForeColor="Red" ValidationGroup="blg" Display="Dynamic"></asp:RequiredFieldValidator>
                  </div>
                  <span class="label-text col-md-2 col-form-label">Name: <span class="requied"> * </span></span>
                  <div class="col-md-4">
                   <asp:TextBox ID="txtName" runat="server" CssClass="form-control"></asp:TextBox>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter name"
                            ControlToValidate="txtName" ForeColor="Red" ValidationGroup="blg" Display="Dynamic"></asp:RequiredFieldValidator>
                  </div>
                </div>
                 <div class="form-group row"> <span class="label-text col-md-2 col-form-label">Image (Blog): <span class="requied"> * </span></span>
                    <div class="col-md-4">
                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                <div id="frm" method="post">
                                    ...
                                    <asp:GridView ID="gvBlog" runat="server" Width="100%" CssClass="table table-striped jambo_table bulk_action"
                                        AutoGenerateColumns="False" DataKeyNames="blog_id,title" OnRowCommand="gvBlog_RowCommand"
                                        OnRowDataBound="gvBlog_RowDataBound" OnRowDeleting="gvBlog_RowDeleting">
                                        <EmptyDataTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Active" ItemStyle-HorizontalAlign="Center" >
                                                <ItemTemplate>
                                                    ...
                                                    <asp:ImageButton ID="imgBtnActive" runat="server" AlternateText='<%# Eval("is_active").ToString().ToLower()=="true" ? "Active" : "Inactive" %>'
                                                        ...
                                                        CommandName="Active" CommandArgument='<%# Eval("blog_id") %>' />
                                                </ItemTemplate>
                                                <ItemStyle Width="50px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnImgEdit" runat="server" CommandName="EditRecored"
                                                        CommandArgument='<%# Bind("blog_id") %>' ToolTip="Edit" CssClass="label label-success" style="margin-bottom: 5px;"><i class="fa fa-edit"></i> edit</asp:LinkButton>
                                                    <asp:LinkButton ID="btnImgDelete" runat="server" CommandName="Delete"
                                                        CommandArgument='<%# Bind("blog_id") %>' ToolTip="Delete" CssClass="label label-danger" OnClientClick="javascript:return confirm('Are you sure you want to Remove this Banner!');"><i class="fa fa-trash"></i> delete</asp:LinkButton>
                                                </ItemTemplate>
