                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Ord ID/Order Date">
                                    <ItemTemplate>
                                        <%# Eval("order_id")%><br />
                                        <%# Eval("OrdDate")%>
                                        <asp:LinkButton ID="ibtnView" runat="server"  AlternateText="View" ToolTip="View" CssClass="label label-info"
                                             PostBackUrl='<%#"~/Admin/searchorderdetails.aspx?id="+Eval("order_id")%>'  ><i class="fa fa-eye"></i> view</asp:LinkButton>
