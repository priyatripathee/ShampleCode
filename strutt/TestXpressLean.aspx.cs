...
namespace strutt
{
    public partial class TestXpressLean : System.Web.UI.Page
    {
        ...
        protected void Post()
        {
            try
            {
                ...
                if (dtCart != null || dtCart.Rows.Count != 0)
                {
                    ...
                    Decimal grandTotal = totalAmount - TotalDiscount + Convert.ToDecimal(shippingcharge) + totalCustomeBagCharge;


                    Session["grandTotal"] = grandTotal;

                    obj.grandtotal = Session["grandTotal"].ToString();
                    ...
                    {
                        obj.preshiptotal = (grandTotal - Convert.ToDecimal(ViewState["ShippingCharge"])).ToString();
                    }
                    ...
                    obj.discount = Convert.ToInt32(TotalDiscount);
                    obj.subtotal = amount.ToString();
                    obj.total = totalAmount.ToString();
                    obj.currency = "INR";
